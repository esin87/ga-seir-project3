...
/// then check id's cause they flippin change each time you re-seed
//////////////////////////////////////////////////////
...
/// until we figure out how to go and get the id back from a get request
// I'll have to hardcode for testing - below works but commented out since re-seed = new id's
...
//                  console.log(response.body.property.title);
//                  console.log(response.body.info.title);
//                  console.log(response.body.[0].title);
//                  console.log(response.body.[0].info.title);
//                  console.log(response.body.[0].property.title);
//                  console.log(response.body.info.property.title);
//                 expect(response.body).to.have.property("_id");
//                 expect(response.body).to.have.property("title");
//                 expect(response.body).to.have.property("category");
//                 expect(response.body).to.have.property("description");
...
//but gives 2000 ms timeout error when testing ... id not found
...
// delete by id
/// ids change when re-seed db - this should work this time - need to learn the syntax for going and looking up
